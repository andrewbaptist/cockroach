...
// measurements.
//
// It only updates the offset for the node if one of the following cases holds:
// 1. There is no prior offset for that node.
// 2. The old offset for the node was measured long enough ago to be considered
// stale.
